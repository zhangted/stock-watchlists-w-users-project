...
class WatchlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create watchlist" do
    assert_difference('Watchlist.count') do
      post watchlists_url, params: { watchlist: { name: @watchlist.name, tickers: @watchlist.tickers, user_id: @watchlist.user_id } }
    end
  ...
  test "should update watchlist" do
    patch watchlist_url(@watchlist), params: { watchlist: { name: @watchlist.name, tickers: @watchlist.tickers, user_id: @watchlist.user_id } }
